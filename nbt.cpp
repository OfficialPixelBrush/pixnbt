...
void NbtWriteToStream(std::ofstream stream, std::shared_ptr<Tag> tag, int algorithm) {
...
std::shared_ptr<Tag> NbtReadFromStream(std::string filename, int algorithm, size_t multiplier, size_t maxSize) {
